...
<body> <!-- abertura da tag do corpo da página -->
    ...
    <?php endif ?>
    <?php if ($vencedor == 'jogador1' || $vencedor == 'jogador2'): ?> <!-- caso a condição de cima não for atendida então o programa irá fazer essa checagem que verifica se a variável $vencedor tem o valor sendo igual a jogador1 ou jogador2 -->
