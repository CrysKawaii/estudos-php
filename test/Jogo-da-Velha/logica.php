...
$url = "http://localhost/test/jogo-da-velha/index.php?"; // declara a variável url que será utilizada para o redirecionamento da página principal com os parâmetros na URL que poderam ser passados e conseguidos para usar como dados para o tratamento dos mesmo no index.php
